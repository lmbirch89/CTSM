...
#include "shr_assert.h"
  ...
  type, public :: waterstate_type
     ...
     real(r8), pointer :: snow_10day             (:)   ! lbirch: 10day avg col snow height of snow covered area (m)
...
!         ptr_col=this%h2osoi_liq_col, l2g_scale_type='veg')
    ...
    !lbirch added snow depth avg
    this%snow_10day(begc:endc) = spval
    call hist_addfld1d (fname='SNOW_10D',  units='m',  &
         avgflag='A', long_name='10 day avg snow height of snow covered area', &
         ptr_col=this%snow_10day, c2l_scale_type='urbanf',default='inactive')
